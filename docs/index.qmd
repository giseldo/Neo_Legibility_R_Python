...
A polaridade do sentimento (ou tom) da descrição da User Story, a subjetividade da descrição da User Story e a legibilidade da descrição da da User Story são bons preditores da estimativa de esforço em Story Points.
...
## Atributos preditores extraídos da User Story {.smaller }
